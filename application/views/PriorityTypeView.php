<div class="x_panel" style="min-height:600px; height: auto;">
    <div class="x_title">
        <h2>Priority Type<small></small></h2>
        <!--<a href="<?php echo base_url() ?>addPriorityType" id="send"  class="btn btn-success" style="float:right;">Add Priority Type</a>-->
...
<!--                        <td><form action="<?php //echo base_url(); ?>updatePriorityType" method="post">
