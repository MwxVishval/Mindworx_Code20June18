<div class="x_panel" style="min-height:600px; height: auto;">
    <div class="x_title">
        <h2>FSE Type <small></small></h2>
        <a href="<?php echo base_url() ?>addFSEType" id="send"  class="btn btn-success" style="float:right;">Add FSE Type</a>
            ...
            <tbody>
                ...
                foreach ($result AS $r) {
                    ...
                    <tr>
                        ...
                        <td><form action="<?php echo base_url(); ?>updateFSEType" method="post">
