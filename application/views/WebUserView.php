...
<div class="x_panel" style="min-height:600px; height: auto;">
    <?php $CI = & get_instance(); ?>
    <?php if ($CI->userPermissionMenu(12, 2) == TRUE) { ?>
    <div class="x_title">
        <h2>WebUser <small></small></h2>
        <a href="<?php echo base_url() ?>addWebuser" id="send"  class="btn btn-success" style="float:right;">Add WebUser</a>
        ...
        <table id="datatable-buttons" class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                foreach ($result AS $r) {
                    ...
                    <tr>
                        <td><?php echo $i++ ?></td>
                        <td><?php echo $r['web_name']; ?></td>
                        <td><?php echo $r['web_username']; ?></td>
                        <td><?php echo $r['web_user_type']; ?></td>
                        <td><form action="<?php echo base_url(); ?>updateWebuser" method="post">
                                <input type="hidden" value="<?php echo $r['id']; ?>" name="edit_id"  />
                                <input type="hidden" value="<?php echo $r['user_type']; ?>" name="user_type"  />
                                ...
                                <?php if ($r['id'] != $this->session->userdata('session_data')->user_id) { ?>
